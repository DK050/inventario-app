<x-app-layout>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="flex items-center">
                    <img class="h-8 w-8 rounded-full object-cover" src="https://placehold.co/100x100/f8b4b4/ffffff?text=A"
                        alt="Admin Avatar">
    ...
    <div class="py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <div class="p-4 flex flex-col sm:flex-row justify-between sm:items-center gap-4">
                ...
                <button id="addProductBtn"
                    class="w-full sm:w-auto bg-pink-500 text-white px-4 py-2 rounded-lg hover:bg-pink-600 transition-colors flex items-center justify-center">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <table class="w-full min-w-[640px]">
                <thead class="bg-gray-50">
                    <tr>
                        <th class="p-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Producto
                        </th>
                        <th
                            class="hidden lg:table-cell p-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            Categoría</th>
                        ...
                        <th
                            class="hidden sm:table-cell p-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            Estado</th>
                        <th class="p-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Acciones
                        </th>
                    </tr>
                </thead>
        ...
        <x-modal name="product-modal">
            <form id="productForm" class="p-6" action="/products" method="POST">
                @csrf
                <div class="flex justify-between items-center border-b pb-3 mb-4">
                    <h2 id="modalTitle" class="text-2xl font-bold text-gray-800">Agregar Producto</h2>
                    <button id="closeModal" type="button" class="text-gray-400 hover:text-gray-600">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select id="productCategory"
                            class="mt-1 w-full px-3 py-2 border border-gray-300 bg-white rounded-md shadow-sm focus:ring-pink-500 focus:border-pink-500"
                            required>
                    ...
                    <div>
                        <label for="productStock" class="block text-sm font-medium text-gray-700">Cantidad en
                            Stock</label>
                    ...
                    <div class="md:col-span-2">
                        <label for="productImage" class="block text-sm font-medium text-gray-700">URL de la
                            Imagen</label>
                ...
                <div class="mt-6 flex justify-end space-x-3">
                    ...
                    <button type="submit"
                        class="bg-pink-500 text-white px-4 py-2 rounded-lg hover:bg-pink-600">Guardar</button>
                </div>
            </form>
        </x-modal>
